...
2. 角色词表：`Leader / ProductManager / Architect / Designer / FrontendDev / BackendDev / Tester / Reviewer / DevOps / ArchReviewer / DesignReviewer / ProductReviewer / FrontendReviewer / BackendReviewer / TestReviewer`
...
7. 专属 Reviewer 只承担对应专业评审：`ArchReviewer / DesignReviewer / ProductReviewer / FrontendReviewer / BackendReviewer / TestReviewer`，不替代 Leader 的门禁职责。
...
| DevOps | `DevOps-core-u3001` | CI/CD 与部署（成员工号 u3001）|
| Leader | `Leader-core-u0001` | 核心小队 Leader（成员工号 u0001）|
| BackendReviewer | `BackendReviewer-user-service-u4001` | 后端专业评审（成员工号 u4001）|
