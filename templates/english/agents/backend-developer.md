...
- Produce the API contract (path / request / response / error codes) for the frontend to wire up and the tester to write API cases
- Implement server-side logic / data models
