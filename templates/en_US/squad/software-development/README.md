...
This Starter has 7 roles: the Leader owns orchestration and gatekeeping; Architect (technical) / Designer (Figma UI) / FrontendDev / BackendDev / Tester each own a piece of the artifacts, and the **Reviewer does the business review**.
